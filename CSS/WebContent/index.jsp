			...
			<div class="columns">
				...
				<div class="nav-sections">
					<div class="navigation">
						<ul class="menu">
							<li class="active"><a href="index.html" title="首页"><span>首页</span></a></li>
							<li onmousemove="showmenu_header(this)"
								...
								<ul>
									...
									<li class="thirdmenu"
										" onmousemove="showmenu_header_third(this)"
										onmouseout="hidemenu_header_third(this)"><a
		...
		<div class="pagr-footer">
			<div class="footer_wrapper">
				<div class="columns">
					...
					<div class="footer-menu">
						<ul class="menu">
							<li class="level-1">
								...
								<ul class="menu">
									<li class="level-2"><a href="cn-to-hk-process.html"
										title="國內至香港教學"><span>國內至香港教學</span></a></li>
									<li class="level-2"><a href="cn-to-tw-process.html"
										title="國內至台灣教學"><span>國內至台灣教學</span></a></li>
									<li class="level-2"><a href="cn-to-xmt-process.html"
										title="國內至新加坡/馬來西亞教學"><span>國內至新加坡/馬來西亞教學</span></a></li>
									<li class="level-2"><a href="cn-to-oversea-process.html"
										title="國內至海外教學"><span>國內至海外教學</span></a></li>
								</ul>
							</li>
							<li class="level-1">
								...
								<ul class="menu">
									...
									<li class="level-2"><a href="cn-to-tw-intro.html"
										title="到台灣"><span>到台灣</span></a></li>
									<li class="level-2"><a href="cn-to-xmt-intro.html"
										title="到新加坡/馬來西亞"><span>到新加坡/馬來西亞</span></a></li>
									<li class="level-2"><a href="cn-to-oversea-intro.html"
										title="到海外"><span>到海外</span></a></li>
									<li class="level-2"><a href="cn-return-services.html"
										title="國內退件"><span>國內退件</span></a></li>
									<li class="level-2"><a href="memapply_cntohk.aspx"
										title="貨物認領"><span>貨物認領</span></a></li>
									<li class="level-2"><a href="memapply_cntohk.aspx"
							...
							<li class="level-1">
								...
								<ul class="menu">
									<li class="level-2"><a href="help_getintegral.html"
										title="如何獲得積分"><span>如何獲得積分</span></a></li>
									<li class="level-2"><a href="help_howtopay.html"
										title="如何支付費用"><span>如何支付費用</span></a></li>
									<li class="level-2"><a href="cn_inquire.html" title="物流跟蹤"><span>物流跟蹤</span></a></li>
									<li class="level-2"><a href="help_getintegral.html"
										title="更多..."><span>更多...</span></a></li>
								</ul>
							</li>
							<li class="level-1">
					...
					<div class="qr-code">
						<div class="text">
							<a href="cn_app.html">IOS App</a>
						</div>
						<div class="image">
							<img src="images/ios-app200.jpg" width="110px" height="110px"
								alt="buyup ios app" />
						</div>
					</div>
					<div class="qr-code2">
						<div class="text">
							<a href="cn_app.html">Android App</a>
						</div>
						<div class="image">
							<img src="images/android_barcode.gif" width="110px"
								height="110px" alt="buyup android app" />
						</div>
					</div>
				</div>
			</div>
